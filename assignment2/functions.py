...
def get_past_victories():
    victories = 0
    # it counts the amount of times the word "stars" appears.
    # because stars always mean victory
    try:
        with open("assignment2/save.txt", "r") as file:
...
def save_game(winner, hero_name="", num_stars=0):
    with open("assignment2/save.txt", "a") as file:
        if winner == "Hero":
            file.write(f"Hero {hero_name} has killed a monster and gained {num_stars} stars.\n")
        elif winner == "Monster":
            file.write("Monster has killed the hero previously\n")
    with open("assignment2/save.txt", "a") as file:
        file.write("The hero has kiled the monster "+ str(get_past_victories()) + " times\n")
...
def load_game():
    try:
        with open("assignment2/save.txt", "r") as file:
            ...
            print(f"   | The hero has killed the monster {str(get_past_victories())} times")
            lines = file.readlines()
            if lines:
                # changed it to 2nd last line because the last line will always say how many times the monster has been killed
